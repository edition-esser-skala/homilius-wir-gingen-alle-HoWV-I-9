...
SchliesstDieFondamento = {
  \relative c {
    ...
    \partial 8 r8 r \mvTr g'(\fE-\soloE fis e)
    r dis( cis h)
    e4 h
    e, e'
    r c %5
    ...
    h h
    h g'
    r8 \once \slurDashed fis( g e)
    r \once \slurDashed dis( h dis) %90
    e4 h
    e,8 e' d!4
    r c
    r h
    ...
    c a,
    r h
    e, r \bar "S-S" %165 finis
  }
}

SchliesstDieBassFigures = \figuremode {
  r8 r <6> <7>4
  r8 <6> <7> <7 _+>
  r4 <_+>
  r2
